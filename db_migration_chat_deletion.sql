...
AND COLUMN_NAME IN ('is_deleted_for_everyone', 'is_deleted_for_me');

-- Show indexes on the chats table
SHOW INDEX FROM `chats` WHERE Column_name IN ('is_deleted_for_everyone', 'is_deleted_for_me');